...
<% WhiteTree.Models.PageObject po = Model.PageObjects.FirstOrDefault();  %>
<form action="<%= Url.RouteUrl("Default", new { action="UpdatePageContent", id=Model.PageID})%>" class="droppable">
